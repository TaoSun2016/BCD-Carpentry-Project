...
go
CREATE TABLE TOOL_USER_REGISTER (
...
CREATE TABLE TOOL_LIST (
  ...
  Competent      int DEFAULT 0 NOT NULL CHECK(Competent in (0,1)), 
...
ALTER TABLE TOOL_USER_REGISTER ADD CONSTRAINT FK_TOOLUSER_EMPLOYEE FOREIGN KEY (EmployeeID) REFERENCES EMPLOYEE (EmployeeID);
...
ALTER TABLE TOOL_USER_REGISTER ADD CONSTRAINT FK_TOOLUSER_CATEGORY FOREIGN KEY (ToolName) REFERENCES TOOL_CATEGORY (ToolName);
