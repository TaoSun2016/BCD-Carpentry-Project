use HRMSDB
go
drop procedure sp_addTimeSheet
go
create procedure sp_addTimeSheet(
	@Forename	varchar(50),
	@Surname	varchar(50),
	@Email		varchar(100),
	@WeekEndingDate	date,
	@MainContractor	varchar(60),
	@JobName	varchar(60),
	@Date		date,
...
begin
	...
	begin try
		insert into TIME_SHEET  values (@EmployeeID, @WeekEndingDate, @MainContractor, @JobName, @Date, @Description, @StartTime, @EndTime, @Hours)
	end try
	begin catch
